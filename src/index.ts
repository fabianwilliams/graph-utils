 ...
 */
export const toGraphTime = (date: Date): string => date.toISOString();
 ...
 */
export const fromGraphTime = (isoString: string): Date => new Date(isoString);
